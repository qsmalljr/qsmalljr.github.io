...
module.exports = {
  ...
  siteMetadata: {
    title: `Quentin Small Jr.`,
    author: `Quentin Small Jr.`,
    firstName: `Quentin`,
    lastName: `Small Jr.`,
    description: `Quentin's personal site`,
    occupation: `Software Engineer, Game Developer, Coffee Lover`,
    keywords: [`Quentin`, `Small`, `Personal`, `Blog`, `Resume`, `Projects`, `Work`],
    siteUrl:
  ...
  plugins: [
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        name: `Quentin Small's Personal Site`,
        short_name: `Q.Small`,
        ...
        theme_color: `#fff`,
        display: `standalone`,
        icon: `${__dirname}/static/icons/Q-Logo.png`, // This path is relative to the root of the site.
      },
    },
